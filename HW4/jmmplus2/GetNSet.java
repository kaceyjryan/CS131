...
class GetNSet implements State
{
	...
	GetNSet(byte[] v) { value = new AtomicIntegerArray(ConvertByte2IntArray(v)); maxval = 127; }

	GetNSet(byte[] v, byte m) { value = new AtomicIntegerArray(ConvertByte2IntArray(v)); maxval = m; }
