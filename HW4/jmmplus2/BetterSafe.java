...
class BetterSafeState implements State
{
	...
	BetterSafeState(byte[] v) { value = new AtomicIntegerArray(ConvertByte2IntArray(v)); maxval = 127; }
	
	BetterSafeState(byte[] v, byte m) { value = new AtomicIntegerArray(ConvertByte2IntArray(v)); maxval = m; }	
